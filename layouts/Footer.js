            ...
            >
              <div className="single-footer-widget">
                ...
                <div className="footer-content">
                  <p className="mb-3">
                    Key West's favorite food truck serving fresh, delicious
                    meals with island flavor.
                  </p>
                  <div className="social-icon d-flex align-items-center">
                    <a
                      href="https://facebook.com/thewanderingrooster"
                      target="_blank"
                    ...
                    <a
                      href="https://www.tiktok.com/discover/the-wandering-rooster-food-truck"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
